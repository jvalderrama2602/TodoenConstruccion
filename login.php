...
function enviarHTTPc ()
{
	...
	alert(lista_category)
	alert(valorSeleccionado_lista_category)
						...
						<div class="col-md-12">
							<div class="main-content">
								<div class="commerce commerce-account">
									...
									<form class="login" name="formulario_usuario" method="post" action="entrar.php">
										...
										<div class="form-row form-row-wide">
											...
											<input class="input-text" type="password" name="passc" id="passc" name="password"/>
										</div>
										<div class="form-row form-row-wide">
											<label for="login">
