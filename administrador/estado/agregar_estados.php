...
function enviarHTTP () 
{
	...
	if(valor!="")
	{
		...
		http.open ("GET", "grabar_estados.php?" + query, true);
...
<tr>
	<td>NOMBRE</td>
    <td width="285">
        <input type="text" name="nombre" size="45" maxlength="20" placeholder=" Nombre Del Estado" onkeypress="return validar(event)"/>
    </td>
</tr>
</table>
