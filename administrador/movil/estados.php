  ...
  <body>
    ...
    <div id="main" class="main">
      ...
      <div id="toolbar" class="nav-material">
        ...
        <h1 class="title none">Estados</h1>
  ...
  <?php
   ...
   <div class="upnext">
          <h5></h5>
           ...
           echo "<a href='modificar_usuarios.php?codigo=+<?=$idestado;?>'  target='_blank' onClick='window.open(this.href, this.target,'width=1130,height=650,scrollbars=yes,top=60,left=90,menubar=NO,titlebar=NO'); return false;' class='remove' title='Editar éste estado'><i class='ion-ios-more'></i></a>";
          echo"  </div>";
          }
          ?>
