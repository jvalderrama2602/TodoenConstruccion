  ...
  <body>
    ...
    <div id="main" class="main">
      ...
      <div id="toolbar" class="nav-material">
        ...
        <h1 class="title none">Productos</h1>
  ...
  <?php
   ...
   <div class="upnext">
          ...
          <h5></h5>
           ...
           echo "<span>$nombre_estado&nbsp-&nbsp</span>";
           ...
           echo "<span>$fila60[nombre_categoria]&nbsp-&nbsp</span> \n";
...
<form name="formulario_usuario05">
...
<label for="first_name">Ingrese Nombre del producto</label>
...
<a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat" onclick="enviarHTTP05()">Agregar</a>
