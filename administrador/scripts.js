  ...
  function mostrar(x){
    ...
    switch (x) {
      ...
      div=document.getElementById("wrapper5");
      div.style.display='none';
      div=document.getElementById("wrapper6");
      div.style.display='none';
      break;
      case 1:
      div=document.getElementById("wrapper2");
...
function respuestaHTTP05 ()
{
  if (http.readyState == 4)
  {
    if (http.status == 200)
    {
      ...
      if(respuesta_php=="")
      {
        document.getElementById('x105').style.display = '';
        document.getElementById('x205').style.display = 'none';
      }
      else
      {
        document.getElementById('x105').style.display = 'none';
        document.getElementById('x205').style.display = '';
