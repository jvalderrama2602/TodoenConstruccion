...
function enviarHTTP () 
{
	...
	var categoria = window.document.formulario_usuario.category.value; 
	
	if(nombre!="" && categoria!=0)
	{
		var query= "nombre=" + nombre +"&categoria=" + categoria;
		http.open ("GET", "grabar_tipo_producto.php?" + query, true);
...
<tr><td align="center" colspan="2">TIPO DE PRODUCTO</td></tr>
<tr>
	<td>CATEGORIA</td>
	<td>
